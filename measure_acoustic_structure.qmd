...
```{r}
ggplot(sp_pcs, aes(x = PC1, y = PC2, color = sound.files, shape =  sound.files)) +
  geom_point(size = 5) +
  scale_color_viridis_d(option = "G", end = 0.9, direction = -1) +
  theme_classic() +
  labs(x = "PC1", y = "PC2") +
...
```{r}
ggplot(cc_pcs, aes(x = PC1, y = PC2, color = sound.files, shape =  sound.files)) +
  geom_point(size = 5) +
  scale_color_viridis_d(option = "G", end = 0.9, direction = -1) +
  theme_classic() +
  labs(x = "PC1", y = "PC2") +
...
# present xcor as a heatmap using ggplot2
  ggheatmap(xcor) +
    scale_fill_viridis_c(option = "G", direction = 1, begin = 0.1, end = 0.8) +
...
```{r}
ggplot(xcor_mds, aes(x = mds.1, y = mds.2, color = sound.files, shape =  sound.files)) +
  geom_point(size = 5) +
  scale_color_viridis_d(option = "G", end = 0.9, direction = -1) +
  theme_classic() +
  labs(x = "MDS1", y = "MDS2") +
...
```{r}
ggplot(dtw_mds, aes(x = mds.1, y = mds.2, color = sound.files, shape =  sound.files)) +
  geom_point(size = 5) +
  scale_color_viridis_d(option = "G", end = 0.9, direction = -1) +
  theme_classic() +
  labs(x = "MDS1", y = "MDS2") +
